...
describe('CustomWsClientService', () => {
  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [CustomWsClientService]
    });
  });

  it('should be created', () => {
    // given
    const service: any = TestBed.get(CustomWsClientService);
    // when
  ...
  it('should handle on close', () => {
    ...
    const url = 'wss://abc';
    const channel: any = {};
    const connect = { next: () => { called = true; } };
  ...
  it('should handle message', () => {
    ...
    const url = 'wss://abc';
    const channel: any = {};
    const message = { next: () => { called = true; } };
    const connection = { channel, message };
